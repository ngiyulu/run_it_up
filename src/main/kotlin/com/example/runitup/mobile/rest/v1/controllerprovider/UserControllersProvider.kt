...
import com.example.runitup.mobile.rest.v1.controllers.InitializeController
import com.example.runitup.mobile.rest.v1.controllers.user.*
import com.example.runitup.mobile.rest.v1.controllers.user.update.*
...
class UserControllersProvider {
    ...
    @Autowired
    lateinit var generateExpiredTokenController: GenerateExpiredTokenController

    @Autowired
    lateinit var requestOtpController: RequestOtpController
