...
class InitializeController: BaseController<InitializeRequest, InitializeResponse>() {
    ...
    override fun execute(request: InitializeRequest): InitializeResponse {
        ...
        return InitializeResponse(gyms, user, token.orEmpty(), true, 3, "", appConfig.baseUrl+"/ios/run", "", false,  GuideLineUtil.provideGuideLineList(), userStats = stats, refundUrl = appConfig.refundUrl, appConfig.messaging, adminUser, appConfig.privacyUrl, appConfig.termsAndConditionUrl, appConfig.displayDays).apply {
