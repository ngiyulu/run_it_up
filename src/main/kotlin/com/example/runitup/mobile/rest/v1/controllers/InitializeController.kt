...
//        )
        ...
        val guidelines = listOf(
            ...
            GuideLine(
                title = "Play Fair",
                description = "Compete with integrity. No cheating, unnecessary roughness, or unsportsmanlike conduct. RunItUp is built on trust and fairness.",
                image = "fairplay_icon"
            ),
            GuideLine(
            ...
            GuideLine(
                title = "Keep It Safe",
                description = "Play under control and avoid reckless behavior that could cause injuries. Safety always comes before winning.",
                image = "safety_icon"
            ),
            GuideLine(
                title = "Respect the Host and Rules",
                description = "Follow the rules set by the gym or host. They ensure that games run smoothly and everyone enjoys their time.",
                image = "host_icon"
            ),
            GuideLine(
