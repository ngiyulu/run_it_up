...
import com.example.runitup.web.rest.v1.dto.user.UpdateSkillLevel
import org.springframework.security.core.context.SecurityContextHolder
import org.springframework.stereotype.Service

@Service
class UpdateSkillLevelController: BaseController<UpdateSkillLevel, User>() {
    override fun execute(request: com.example.runitup.web.rest.v1.dto.user.UpdateSkillLevel): User {
