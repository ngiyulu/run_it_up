...
import com.example.runitup.web.rest.v1.controllers.file.ProfileImageUploader
...
class FileRestController{
    ...
    fun uploadImage(
        ...
        return profileImageUploader.execute(com.example.runitup.web.rest.v1.dto.FileUploadModel(file))
    }
