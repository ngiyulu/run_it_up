...
import com.example.runitup.web.rest.v1.dto.SessionListModel
...
class GetRunSessionListController: BaseController<SessionListModel, List<RunSession>>() {
    ...
    override fun execute(request: com.example.runitup.web.rest.v1.dto.SessionListModel): List<RunSession> {
